...
app.use(cors({ origin: [process.env.REACT_APP_FRONTEND_URL, "http://localhost:3000"], methods: ["GET", "POST"] })); // Allow frontend to communicate with backend, change to domain later
