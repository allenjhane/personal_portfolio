...
app.use(cors({ origin: [process.env.REACT_APP_FRONTEND_URL, process.env.FRONTEND_URL_LOCAL], methods: ["GET", "POST"] })); // Allow frontend to communicate with backend, change to domain later
